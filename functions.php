...
/*Post type: SLIDER*/
  ...
  /*Post type: CLAIM*/
    ...
    /*Post type: BOTTONI HP*/
      ...
      // aggiungiamo ora tutte le impostazioni necessarie, in primis definiamo le varie etichette mostrate nei menù
        array('labels' => array(
            'name' => 'Box HP', /* Nome, al plurale, dell'etichetta del post type. */
            'singular_name' => 'Box', /* Nome, al singolare, dell'etichetta del post type. */
            'all_items' => 'Tutti i box', /* Testo mostrato nei menu che indica tutti i contenuti del post type */
            'add_new' => 'Aggiungi nuovo', /* Il testo per il pulsante Aggiungi. */
            'add_new_item' => 'Aggiungi nuovo Box', /* Testo per il pulsante Aggiungi nuovo post type */
            'edit_item' => 'Modifica Box', /*  Testo per modifica */
            'new_item' => 'Nuovo Box' /* Testo per nuovo oggetto */
          ), /* Fine dell'array delle etichette */
            'description' => 'Elenco Box', /* Una breve descrizione del post type */
      ...
      /*Post type: GIURIA*/
        ...
        /*Post type: WINNER*/
          ...
          /*Post type: SPONSOR */
            register_post_type( 'sponsor', /* nome del custom post type */
            // aggiungiamo ora tutte le impostazioni necessarie, in primis definiamo le varie etichette mostrate nei menù
              array('labels' => array(
                  'name' => 'Sponsor', /* Nome, al plurale, dell'etichetta del post type. */
                  'singular_name' => 'Sponsor', /* Nome, al singolare, dell'etichetta del post type. */
                  'all_items' => 'Tutti gli Sponsor', /* Testo mostrato nei menu che indica tutti i contenuti del post type */
                  'add_new' => 'Aggiungi nuovo', /* Il testo per il pulsante Aggiungi. */
                  'add_new_item' => 'Aggiungi nuovo Sponsor', /* Testo per il pulsante Aggiungi nuovo post type */
                  'edit_item' => 'Modifica Sponsor', /*  Testo per modifica */
                  'new_item' => 'Nuovo Sponsor' /* Testo per nuovo oggetto */
                ), /* Fine dell'array delle etichette */
                  'description' => 'Elenco Sponsor', /* Una breve descrizione del post type */
                  //'menu_icon' => get_stylesheet_directory_uri() . '/images/gp30/icons/winner.png', /* Scegli l'icona da usare nel menù per il posty type */
                  'public' => true, /* Definisce se il post type sia visibile sia da front-end che da back-end */
                  /* la riga successiva definisce quali elementi verranno visualizzati nella schermata di creazione del post */
                  'has_archive' => true,
